...
class ExperimentPlanner3D_v21_24GB(ExperimentPlanner3D_v21):
    """
    Same as ExperimentPlanner3D_v21, but designed to fill a V100 (24GB) in fp16
    """
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        # typical ExperimentPlanner3D_v21 configurations use ~8.5GB, but on a V100 we have 24. Allow for more space
        # to be used
