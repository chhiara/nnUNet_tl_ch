...
class nnUNetTrainerV2_64mini_250epochs_noDA(nnUNetTrainerV2):
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            if not isfile(splits_file):
                self.print_to_log_file("Creating new 3-fold cross-validation split...")
                splits = []
